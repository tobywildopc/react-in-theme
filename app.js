		...
		<form>
			...
			{ this.state.currentPage === 'one' && 
				<div id="page1">					
					...
					<CheckList errors={this.state.errors} selected={this.state.ratingSelected} section="rating" options={this.state.rating} onChange={this.handleChange} />
					
					<hr />
					
					<h2>What type of building?</h2>
					<CheckList errors={this.state.errors} selected={this.state.buildingSelected} section="building" options={this.state.building} onChange={this.handleChange} />
					...
					{ this.state.buildingSelected === 'Office' && 
						<div>
							...
							<CheckList errors={this.state.errors} selected={this.state.officeSelected} section="office" options={this.state.office} onChange={this.handleChange} />
							<hr />
						</div>
					}
					...
					{ this.state.buildingSelected === 'Data centre' && 
						<div>
							<h2>What is the scope of your rating?</h2>
							<CheckList errors={this.state.errors} selected={this.state.dataSelected} section="data" options={this.state.data} onChange={this.handleChange} />
							<hr />
						</div>
					}
					
					<h2>What is the postcode of the building?</h2>
					<input name="postcode" type="number" min="0" max="9999" value={this.state.postcode} onChange={this.handleChange} />
				  
					<hr />
				  
					<input name="two" type="submit" value="Next" onClick={this.handleNavigation} />
				</div>
			}
			...
			{ this.state.currentPage === 'two' && 
				<div id="page2">
					...
					<input name="floorSpace" type="text" value={this.state.floorSpace} onChange={this.handleChange} /> m<sup>2</sup>
					
					<hr />
					
					<h2>How many hours per week is the building occupied?</h2>
					<input name="occupiedHours" type="text" value={this.state.occupiedHours} onChange={this.handleChange} /> hours
					...
					{ this.state.ratingSelected === 'Energy' && 
						<div id="energy">
							...
							<input name="kWHours" type="text" value={this.state.kWHours} onChange={this.handleChange} /> kWh
							
							<hr />
							
							<h2>What percentage of the total electricity use is GreenPower?</h2>
							<input name="greenPerc" type="text" value={this.state.greenPerc} onChange={this.handleChange} /> %
					...
					{ this.state.ratingSelected === 'Water' && 
						<div id="water">
							...
							<input name="totalWater" type="text" value={this.state.totalWater} onChange={this.handleChange} /> kl
							
							<hr />
							
							<h2>What percentage of the total water consumption is externally supplied recycled water?</h2>
							<input name="waterPerc" type="text" value={this.state.waterPerc} onChange={this.handleChange} /> %
							
							<hr />
						</div>
					}
					
					<input name="one" type="submit" value="Back" onClick={this.handleNavigation} />
					<input name="three" type="submit" value="Next" onClick={this.handleNavigation} />
			...
			{ this.state.currentPage === 'three' && 
				<div id="page3">
					...
					<br />
					<input name="two" type="submit" value="Back" onClick={this.handleNavigation} />
				</div>
			}
